<template>
    ...
    >
        ...
        <div>
            ...
            <h5 class="pl-2 my-2 text-sm theme-text">Select date</h5>
            ...
            <div class="grid grid-cols-7 gap-2 text-bold">

                <!-- Week day names -->
                <div v-for="weekDay in weekDayNames" class="flex items-center justify-center text-base theme-text">
                    {{ weekDay }}
                </div>

                <!-- Days of previous month ( skipped ) -->
                <div v-for="day in prevMonthDaysToSkip" class="flex items-center justify-center text-gray-500"></div>
                ...
                <button
                    ...
                    class="flex items-center justify-center w-12 h-12 text-sm bg-gray-500 rounded-full theme-text bg-opacity-10 hover:bg-opacity-50"
                >
                    {{ day.getDate() }}
                </button>

                <!-- Days of the next month ( skipped ) -->
                <div v-for="day in nextMonthDaysToSkip" class="flex items-center justify-center text-gray-500">
                </div>
        ...
        <div class="flex flex-col mt-5 space-y-5">
            ...
            <!-- Select Time -->
            <h5 class="pl-2 my-2 text-sm theme-text">Select time</h5>
